...
const WavvieMovie = () => {
  ...
  const wavvieList = [
    {id:1, src:require('../../asset/wavviemovie/wvmv001.jpg'), alt:'wvmv001', title:'악마를 보았다'},
    {id:2, src:require('../../asset/wavviemovie/wvmv002.jpg'), alt:'wvmv002', title:'저산 너머'},
    {id:3, src:require('../../asset/wavviemovie/wvmv003.jpg'), alt:'wvmv003', title:'택시2'},
    {id:4, src:require('../../asset/wavviemovie/wvmv004.jpg'), alt:'wvmv004', title:'택시3'},
    {id:5, src:require('../../asset/wavviemovie/wvmv005.jpg'), alt:'wvmv005', title:'택시4'},
    {id:6, src:require('../../asset/wavviemovie/wvmv006.jpg'), alt:'wvmv006', title:'택시4'},
    {id:7, src:require('../../asset/wavviemovie/wvmv007.jpg'), alt:'wvmv007', title:'택시4'},
    {id:8, src:require('../../asset/wavviemovie/wvmv008.jpg'), alt:'wvmv008', title:'택시4'},
    {id:9, src:require('../../asset/wavviemovie/wvmv009.jpg'), alt:'wvmv009', title:'택시4'},
    {id:10, src:require('../../asset/wavviemovie/wvmv010.jpg'), alt:'wvmv010', title:'택시4'},
    {id:11, src:require('../../asset/wavviemovie/wvmv011.jpg'), alt:'wvmv011', title:'택시4'},
    {id:12, src:require('../../asset/wavviemovie/wvmv012.jpg'), alt:'wvmv012', title:'택시4'},
    {id:13, src:require('../../asset/wavviemovie/wvmv013.jpg'), alt:'wvmv013', title:'택시4'},
    {id:14, src:require('../../asset/wavviemovie/wvmv014.jpg'), alt:'wvmv014', title:'택시4'},
    {id:15, src:require('../../asset/wavviemovie/wvmv015.jpg'), alt:'wvmv015', title:'택시4'},
    {id:16, src:require('../../asset/wavviemovie/wvmv016.jpg'), alt:'wvmv016', title:'택시4'},
    {id:17, src:require('../../asset/wavviemovie/wvmv017.jpg'), alt:'wvmv017', title:'택시4'},
    {id:18, src:require('../../asset/wavviemovie/wvmv018.jpg'), alt:'wvmv018', title:'택시4'},
    {id:19, src:require('../../asset/wavviemovie/wvmv019.jpg'), alt:'wvmv019', title:'택시4'},
    {id:20, src:require('../../asset/wavviemovie/wvmv020.jpg'), alt:'wvmv020', title:'택시4'},
  ];
  ...
  const onindicatorclick = e =>{
    ...
    if(move>0){
      wavvieSlide.current.style.left=(originLeft+(1250*Math.abs(move)))+"px";
    ...
    return (
        ...
        <div className="HomeMain__wavvie__wrapper">
          ...
          onMouseLeave={onmouseleave}>
            {wavvieList.map( v => {
                return <WavvieMovieList key={v.id} src={v.src} alt={v.alt} title={v.title} date={v.date}/>;
            })}
          </ul>
          <button
