        ...
        <div className="footer__notice__wrapper">
          ...
          <div className="footer__notice__backWrapper">
            <button className="footer__notice__prevBtn" onClick={onleftclick}>
              <img
                src={require('../asset/icon/arrow-notice-left.png')}
                alt="notice_prevBtn"
              ></img>
            </button>
            <button className="footer__notice__nextBtn" onClick={onrightlick}>
              <img
                src={require('../asset/icon/arrow-notice-right.png')}
                alt="notice_prevBtn"
              ></img>
            </button>
          </div>
      ...
      <div className="footer__menu">
        ...
        <p>
          ...
          <span className="first">
            주소 서울특별시 마포구 상암산로 82, SBS 프리즘 타워 14층
          </span>
        ...
        <div className="footer__menu__etc">
          <div className="logo">
            <img
              src={require('../asset/wavvon logo.png')}
              alt="wavvonlogo"
            ></img>
          </div>
          <select>
          ...
          <button className="fb">
            <img src={require('../asset/icon/fb.png')} alt="facebook"></img>
          </button>
          <button className="post">
            <img src={require('../asset/icon/post.png')} alt="naver post"></img>
          </button>
        </div>
      </div>
    </div>
